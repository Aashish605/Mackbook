...
const ModelScroll = () => {
    ...
    useGSAP(() => {
        ...
        tl.call(()=> setTexture('/videos/feature-2.mp4'))
        .to('.box2', { opacity: 1 ,y:0,delay:1})

        tl.call(()=> setTexture('/videos/feature-3.mp4'))
        .to('.box3', { opacity: 1 ,y:0,delay:1})

        tl.call(()=> setTexture('/videos/feature-4.mp4'))
        .to('.box4', { opacity: 1 ,y:0,delay:1})

        tl.call(()=> setTexture('/videos/feature-5.mp4'))
